...
const token = '5616754786:AAFIWSdQ7muOXQfmpXQO2n0oL-f_rdhpa-s';
...
const start = () =>{
    ...
    bot.on('message',async msg=>{
        ...
        if(text === '/start'){
            await bot.sendSticker(chatId, 'https://tlgrm.eu/_/stickers/711/2ce/7112ce51-3cc1-42ca-8de7-62e7525dc332/1.webp');
